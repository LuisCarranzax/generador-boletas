    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-container config-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-header">
          ...
          <button type="button" className="btn-close" onClick={onClose} title="Cerrar modal">✕</button>
        </div>
          ...
          {activeTab === 'general' && (
            <div className="tab-pane">
              <p className="tab-description">
                Ingrese la información oficial de su empresa o negocio independiente. Estos datos aparecerán en el encabezado de sus boletas emitidas.
              </p>
                  ...
                  formData.bankAccounts.map((acc, idx) => (
                    <div key={idx} className="bank-account-card">
                      ...
                      <div className="bank-card-grid">
                        ...
                        <div className="form-group">
                          <label>CCI / Titular (Opcional)</label>
                          <input
                            type="text"
